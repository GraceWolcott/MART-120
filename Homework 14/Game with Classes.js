...
function setup()
{
    ...
    Obstacle1 = new permObstacle(90, 450, 30, 30, 70, 80, 90); 
    Obstacle2 = new permObstacle(620, 100, 40, 40, 120, 130, 140); 
    Obstacle3 = new permObstacle(540, 680, 50, 50, 190, 200, 210); 
